...
Imported from Jira issue [REB-232](https://vfgconsulting.atlassian.net/browse/REB-232).
...
[emiAutomationTest][OSJ-RUNTIME] Mejorar salida de orchestrate con resumen explícito en no-op, escalación y approval gating.

## Capabilities

### New Capabilities
- `reb-232-emiautomationtest-osj-runtime-mejorar-salida-de-orchestrate`: [emiAutomationTest][OSJ-RUNTIME] Mejorar salida de orchestrate con resumen explícito en no-op, escalación y approval gating
...
- Jira: [REB-232](https://vfgconsulting.atlassian.net/browse/REB-232)
- Status: Backlog
