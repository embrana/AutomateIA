...
Imported from Jira issue [AA-15](https://vfgconsulting.atlassian.net/browse/AA-15).
...
[FUNC] Relevamiento Func Modulo Generico.

## Capabilities

### New Capabilities
- `aa-15-func-relevamiento-func-modulo-generico`: [FUNC] Relevamiento Func Modulo Generico
...
- Jira: [AA-15](https://vfgconsulting.atlassian.net/browse/AA-15)
- Status: En curso
- Assignee: Martin Poblet
