...
const TICKET_TRANSITIONS: Record<TicketRuntimeState, Set<TicketRuntimeState>> = {
  DISCOVERED: asSet(['DISCOVERED', 'CONTEXT_IMPORTED', 'DISCOVERY_IN_PROGRESS', 'ROOT_SPEC_REVIEW', 'SPEC_READY', 'BLOCKED', 'ARCHIVED']),
  CONTEXT_IMPORTED: asSet(['CONTEXT_IMPORTED', 'DISCOVERY_IN_PROGRESS', 'ROOT_SPEC_REVIEW', 'SPEC_READY', 'PLANNED', 'BLOCKED', 'ARCHIVED']),
  DISCOVERY_IN_PROGRESS: asSet(['DISCOVERY_IN_PROGRESS', 'ROOT_SPEC_REVIEW', 'SPEC_READY', 'HUMAN_ESCALATION_REQUIRED', 'BLOCKED', 'ARCHIVED']),
  ROOT_SPEC_REVIEW: asSet(['ROOT_SPEC_REVIEW', 'DISCOVERY_IN_PROGRESS', 'SPEC_READY', 'HUMAN_ESCALATION_REQUIRED', 'BLOCKED', 'ARCHIVED']),
  ...
  UNDER_REVIEW: asSet(['UNDER_REVIEW', 'IN_EXECUTION', 'VALIDATION_FAILED', 'READY_FOR_ARCHIVE', 'HUMAN_ESCALATION_REQUIRED', 'BLOCKED', 'ARCHIVED']),
  ...
  HUMAN_ESCALATION_REQUIRED: asSet(['HUMAN_ESCALATION_REQUIRED', 'PLANNED', 'IN_EXECUTION', 'UNDER_REVIEW', 'READY_FOR_ARCHIVE', 'BLOCKED', 'ARCHIVED']),
};
