...
const TICKET_TRANSITIONS: Record<TicketRuntimeState, Set<TicketRuntimeState>> = {
  ...
  SPEC_READY: asSet(['SPEC_READY', 'PLANNED', 'IN_EXECUTION', 'READY_FOR_ARCHIVE', 'BLOCKED', 'ARCHIVED']),
  PLANNED: asSet(['PLANNED', 'IN_EXECUTION', 'HUMAN_ESCALATION_REQUIRED', 'BLOCKED', 'ARCHIVED']),
